...
### In this Repository I have made a Bidirectional LSTM Model and use the State of art Natural Langy=uage Processing, which helps to predict that a given headline is Sarcastic or not.
